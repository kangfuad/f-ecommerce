...
<template>
  <button
    ...
    :class="[
      'inline-flex items-center justify-center font-bold rounded-full transition-all duration-200 cursor-pointer text-center leading-tight focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-theme-page max-w-full',
      disabled ? 'opacity-50 cursor-not-allowed' : 'active:scale-95',
      size === 'sm' && 'px-3.5 sm:px-4 py-2 text-xs gap-1.5',
      size === 'md' && 'px-4 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm gap-2',
      size === 'lg' && 'px-4 sm:px-8 py-3 sm:py-3.5 text-xs sm:text-sm md:text-base gap-2',
